...
def dla34(pretrained=None, n_class=1000, **kwargs):  # DLA-34
    ...
    n_features = model.fc.in_channels
    model.fc = nn.Conv2d(n_features, n_class, kernel_size=(1, 1), stride=(1, 1))
    return model


def dla46_c(pretrained=None, n_class=1000, **kwargs):  # DLA-46-C
...
def dla46x_c(pretrained=None,  n_class=1000, **kwargs):  # DLA-X-46-C
...
def dla60x_c(pretrained=None, n_class=1000,  **kwargs):  # DLA-X-60-C
    BottleneckX.expansion = 2
...
def dla60(pretrained=None,  n_class=1000, **kwargs):  # DLA-60
    Bottleneck.expansion = 2
    model = DLA([1, 1, 1, 2, 3, 1],
...
def dla60x(pretrained=None, n_class=1000, **kwargs):  # DLA-X-60
    BottleneckX.expansion = 2
    model = DLA([1, 1, 1, 2, 3, 1],
                [16, 32, 128, 256, 512, 1024],
                block=BottleneckX, **kwargs)
...
def dla102(pretrained=None, n_class=1000,  **kwargs):  # DLA-102
    Bottleneck.expansion = 2
...
def dla102x(pretrained=None, n_class=1000,  **kwargs):  # DLA-X-102
    BottleneckX.expansion = 2
    model = DLA([1, 1, 1, 3, 4, 1], [16, 32, 128, 256, 512, 1024],
...
def dla102x2(pretrained=None, n_class=1000,  **kwargs):  # DLA-X-102 64
...
def dla169(pretrained=None, n_class=1000, **kwargs):  # DLA-169
    Bottleneck.expansion = 2
