...
for model in se_resnext50_32x4d; do
    for fold in 0 1 2 3 4; do
        LOGDIR=/media/ngxbac/DATA/logs_iwildcam/${model}_2stages/fold_${fold}/
        catalyst-dl run --config=./iwildcam/configs/config.yml \
                        ...
                        --stages/stage2/data_params/train_csv=/media/ngxbac/Bac2/fgvc6/iwildcam/csv/kfold_all/train_$fold.csv.gz:str \
                        --stages/stage2/data_params/valid_csv=/media/ngxbac/Bac2/fgvc6/iwildcam/csv/kfold_all/valid_$fold.csv.gz:str \
